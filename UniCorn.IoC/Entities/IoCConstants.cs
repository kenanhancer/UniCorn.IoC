...
namespace UniCorn.IoC
{
    public static class IoCConstants
    {
        ...
        public static readonly MethodInfo getProxyMethodsMi = typeof(ProxyTypeFactory).GetMethod("CreateMethodInvokers", BindingFlags.Public | BindingFlags.Static);
        ...
        public static readonly ConstructorInfo standartInvocationCi = typeof(StandardInvocation).GetConstructor(new Type[] { typeof(object[]), UniCornConstants.ObjectType, typeof(ProxyMethod) });
    }
}